...
func GetUserDetails(w http.ResponseWriter, r *http.Request){
	...
	var q UserDetails
	if err = query.QueryRow(r.Context().Value("email")).Scan(&q.UserData.CompanyID, &q.UserData.Email,&q.UserData.Name,&q.CompanyName, &q.UserData.ID, &q.UserData.IsHead); err != nil {
		utils.ErrorResponse(w, err)
		return
	}
